...
# Load model
cnn_model = tf.keras.models.load_model(STATIC_FOLDER + "/models/" + "dogcat_model.h5")
...
def classify(model, image_path):
    ...
    prob = cnn_model.predict(preprocessed_imgage, steps=2)
    label = "Dog" if prob[0][0] >= 0.5 else "Cat"
